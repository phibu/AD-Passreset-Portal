...
/// Supported body template tokens: {Username}, {DaysRemaining}, {ExpiryDate}, {PassCoreUrl}
/// </summary>
public class PasswordExpiryNotificationSettings
{
    ...
    /// <summary>Public URL of this PassCore instance, included in notification emails.</summary>
    public string PassCoreUrl { get; set; } = string.Empty;
    ...
    /// {PassCoreUrl}   — link to this PassCore instance
    /// </summary>
    public string ExpiryEmailBodyTemplate { get; set; } =
        ...
        "Please change your password before it expires: {PassCoreUrl}";
}
