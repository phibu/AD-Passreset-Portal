...
public class WebSettings
{
    ...
    /// <summary>
    /// When true, the <see cref="PassCore.Web.Helpers.DebugPasswordChangeProvider"/> and
    /// <see cref="PassCore.Web.Helpers.NoOpEmailService"/> are registered instead of the
